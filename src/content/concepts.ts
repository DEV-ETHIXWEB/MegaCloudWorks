...
export const CONCEPTS: Concept[] = [
  ...
  },
  {
    ...
    palette: [
      { name: 'Dently Teal', hex: '#2FBFAE', usage: 'Primary actions & wordmark' },
      { name: 'Deep Teal', hex: '#0F3630', usage: 'Base surfaces & panels' },
      { name: 'Chart Ink', hex: '#082420', usage: 'Text & headings' },
    ],
    accent: '#2FBFAE',
    accentText: '#1E9E8F',
    accentInk: '#082420',
