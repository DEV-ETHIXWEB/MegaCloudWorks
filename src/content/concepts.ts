...
export const CONCEPTS: Concept[] = [
  {
    ...
    screens: ['Dispatch Board', 'Quote-to-Invoice', 'Photo Job Docs', 'Weekly Schedule', 'Team'],
    screensSubtitle: 'Five screens that run the whole job.',
    ...
    palette: [
      { name: 'Flux Sky', hex: '#40A7E7', usage: 'Primary actions & wordmark' },
      { name: 'Field Amber', hex: '#F5A623', usage: 'Live status & highlights' },
  ...
  },
  {
    ...
    screens: ['Stamp Card', 'Rewards Wallet', 'Nearby Offers', 'Redeem at Till', 'Customer Insights'],
    screensSubtitle: 'Five screens that keep them coming back.',
    ...
    palette: [
      { name: 'Vault Magenta', hex: '#E458B5', usage: 'Primary actions & wordmark' },
      { name: 'Vault Pink', hex: '#E88FD8', usage: 'Chart & gradient accents' },
      { name: 'Ink', hex: '#1A1526', usage: 'Text & dark panels' },
    ],
    accent: '#E458B5',
    accentText: '#CE2796',
    accentInk: '#261223',
  ...
  },
  {
    ...
    screens: ['Book a Slot', 'Booking Confirmed', 'My Appointments', "Today's Schedule", 'Clients'],
    screensSubtitle: 'Five screens that fill the calendar.',
    ...
    palette: [
      { name: 'Slotly Coral', hex: '#F0574A', usage: 'Primary actions & wordmark' },
      { name: 'Confirmed Teal', hex: '#2E5F56', usage: 'Confirmed bookings' },
      { name: 'Slate Ink', hex: '#1A1214', usage: 'Text & dark panels' },
    ],
    accent: '#F0574A',
    accentText: '#D9483C',
    accentInk: '#1A1214',
  ...
  },
  {
    ...
    screens: ['Patient Recall', 'Chart Notes', 'Day Schedule', 'Treatment Plan', 'Patient Records'],
    screensSubtitle: 'Five screens that run the practice.',
    ...
    palette: [
      { name: 'Dently Emerald', hex: '#29AE7D', usage: 'Primary actions & wordmark' },
      { name: 'Deep Emerald', hex: '#112C23', usage: 'Base surfaces & panels' },
      { name: 'Chart Ink', hex: '#0C1D16', usage: 'Text & headings' },
    ],
    accent: '#29AE7D',
    accentText: '#1B7E5A',
    accentInk: '#0C1D16',
  ...
  },
  {
    ...
    screens: ['Pipeline Board', 'Lead Detail', 'Follow-Up Reminders', 'Weekly Digest', 'Team View'],
    screensSubtitle: 'Five screens that move the pipeline.',
    ...
    palette: [
      { name: 'Leadr Indigo', hex: '#7C6FE8', usage: 'Primary actions & wordmark' },
      { name: 'Leadr Violet', hex: '#B565E8', usage: 'Gradient & highlight accents' },
      { name: 'Ink', hex: '#181430', usage: 'Dark surfaces & panels' },
    ],
    accent: '#7C6FE8',
    accentText: '#6D5FE0',
    accentInk: '#181430',
