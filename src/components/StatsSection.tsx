...
export function StatsSection() {
  return (
    <section className="relative isolate overflow-hidden border-y border-[var(--line)] bg-[var(--near-black)]">
      ...
      <div className="relative mx-auto grid max-w-[var(--container-wide)] grid-cols-1 divide-y divide-white/10 px-[var(--edge)] sm:grid-cols-3 sm:divide-x sm:divide-y-0">
        {STATS.map((s, i) => (
